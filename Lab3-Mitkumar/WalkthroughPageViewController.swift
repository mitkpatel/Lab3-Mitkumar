...
class WalkthroughPageViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    var pageHeadings = ["GET DISCOVERED.","INCREASE YOUR BRAND","LAND ACQUISTION"]
    var pageImages = ["Check","Check","Check"]
    var pageSubheading = ["GET POPULAR.","REACH USING RADIUS","WORLD DOMINATION"]
